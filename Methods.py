    ...
    for i in range(len(NDt)):
        ...
        for j in range(len(degree)):
            ...
            if save_step and os.path.isfile(str(example)+'/sol_faber_equ_'+str(equ)+'_free_surf_'+str(free_surf)+'_ord_'+ord+'_'+ind_source+'_Ndt_'+str(Ndt[i])+'_degree_'+str(degree[j])+'_dx_'+str(dx)+'_saved_t.npy'):
                ...
                var0=np.load(str(example)+'/sol_faber_equ_'+str(equ)+'_free_surf_'+str(free_surf)+'_ord_'+ord+'_'+ind_source+'_Ndt_'+str(Ndt[i])+'_degree_'+str(degree[j])+'_dx_'+str(dx)+'_saved_var0.npy')[:-(degree[j]+1)]
                sol_faber_points=np.load(str(example)+'/sol_faber_equ_'+str(equ)+'_free_surf_'+str(free_surf)+'_ord_'+ord+'_'+ind_source+'_points_Ndt_'+str(Ndt[i])+'_degree_'+str(degree[j])+'_dx_'+str(dx)+"_saved.npy")
            else:
                NDt0=0
            ...
            for l in range(NDt0,NDt[i]):
                ...
                if l==(round(NDt[i]*T_frac_snapshot)-1):
                    np.save(str(example)+'/sol_faber_equ_'+str(equ)+'_free_surf_'+str(free_surf)+'_ord_'+ord+'_'+ind_source+'_Ndt_'+str(Ndt[i])+'_degree_'+str(degree[j])+'_dx_'+str(dx)+".npy",var[:nx*ny,0])
                if l%1000==0 and save_step:
                    print('++++++++++++++++++++++++++++++++++++++++      SAVED FA: degree - ',degree[j],', Ndt - ',Ndt[i],", l - ",l)
                    np.save(str(example)+'/sol_faber_equ_'+str(equ)+'_free_surf_'+str(free_surf)+'_ord_'+ord+'_'+ind_source+'_Ndt_'+str(Ndt[i])+'_degree_'+str(degree[j])+'_dx_'+str(dx)+'_saved_var0.npy',var)
                    np.save(str(example)+'/sol_faber_equ_'+str(equ)+'_free_surf_'+str(free_surf)+'_ord_'+ord+'_'+ind_source+'_Ndt_'+str(Ndt[i])+'_degree_'+str(degree[j])+'_dx_'+str(dx)+'_saved_t.npy',l)
                    np.save(str(example)+'/sol_faber_equ_'+str(equ)+'_free_surf_'+str(free_surf)+'_ord_'+ord+'_'+ind_source+'_points_Ndt_'+str(Ndt[i])+'_degree_'+str(degree[j])+'_dx_'+str(dx)+"_saved.npy",sol_faber_points)

            np.save(str(example)+'/sol_faber_equ_'+str(equ)+'_free_surf_'+str(free_surf)+'_ord_'+ord+'_'+ind_source+'_points_Ndt_'+str(Ndt[i])+'_degree_'+str(degree[j])+'_dx_'+str(dx)+".npy",sol_faber_points[::2,:])
            ...
            if os.path.isfile(str(example)+'/sol_faber_equ_'+str(equ)+'_free_surf_'+str(free_surf)+'_ord_'+ord+'_'+ind_source+'_Ndt_'+str(Ndt[i])+'_degree_'+str(degree[j])+'_dx_'+str(dx)+'_saved_t.npy'):
                ...
                os.remove(str(example)+'/sol_faber_equ_'+str(equ)+'_free_surf_'+str(free_surf)+'_ord_'+ord+'_'+ind_source+'_points_Ndt_'+str(Ndt[i])+'_degree_'+str(degree[j])+'_dx_'+str(dx)+"_saved.npy")
    ...
    for i in range(len(NDt)):
        ...
        for j in range(len(degree)):
            ...
            if save_step and os.path.isfile(str(example)+'/sol_rk_equ_'+str(equ)+'_free_surf_'+str(free_surf)+'_ord_'+ord+'_Ndt_'+str(Ndt[i])+'_degree_'+str(degree[j])+'_dx_'+str(dx)+'_saved_t.npy'):
                ...
                var0=np.load(str(example)+'/sol_rk_equ_'+str(equ)+'_free_surf_'+str(free_surf)+'_ord_'+ord+'_Ndt_'+str(Ndt[i])+'_degree_'+str(degree[j])+'_dx_'+str(dx)+'_saved_var0.npy')[:-(degree[j]+1)]
                sol_rk_points=np.load(str(example)+'/sol_rk_equ_'+str(equ)+'_free_surf_'+str(free_surf)+'_ord_'+ord+'_points_Ndt_'+str(Ndt[i])+'_degree_'+str(degree[j])+'_dx_'+str(dx)+"_saved.npy")
            else:
                NDt0=0
            ...
            for l in range(NDt0,NDt[i]):
                ...
                if l%1000==0 and save_step:
                    print('++++++++++++++++++++++++++++++++++++++++      SAVED HORK: degree - ',degree[j],', Ndt - ',Ndt[i],", l - ",l)
                    np.save(str(example)+'/sol_rk_equ_'+str(equ)+'_free_surf_'+str(free_surf)+'_ord_'+ord+'_Ndt_'+str(Ndt[i])+'_degree_'+str(degree[j])+'_dx_'+str(dx)+'_saved_var0.npy',var)
                    np.save(str(example)+'/sol_rk_equ_'+str(equ)+'_free_surf_'+str(free_surf)+'_ord_'+ord+'_Ndt_'+str(Ndt[i])+'_degree_'+str(degree[j])+'_dx_'+str(dx)+'_saved_t.npy',l)
                    np.save(str(example)+'/sol_rk_equ_'+str(equ)+'_free_surf_'+str(free_surf)+'_ord_'+ord+'_points_Ndt_'+str(Ndt[i])+'_degree_'+str(degree[j])+'_dx_'+str(dx)+"_saved.npy",sol_rk_points)

            np.save(str(example)+'/sol_rk_equ_'+str(equ)+'_free_surf_'+str(free_surf)+'_ord_'+ord+'_points_Ndt_'+str(Ndt[i])+'_degree_'+str(degree[j])+'_dx_'+str(dx)+".npy",sol_rk_points[::2,:])
            ...
            if os.path.isfile(str(example)+'/sol_rk_equ_'+str(equ)+'_free_surf_'+str(free_surf)+'_ord_'+ord+'_Ndt_'+str(Ndt[i])+'_degree_'+str(degree[j])+'_dx_'+str(dx)+'_saved_t.npy'):
                ...
                os.remove(str(example)+'/sol_rk_equ_'+str(equ)+'_free_surf_'+str(free_surf)+'_ord_'+ord+'_points_Ndt_'+str(Ndt[i])+'_degree_'+str(degree[j])+'_dx_'+str(dx)+"_saved.npy")
    ...
    for i in range(len(NDt)):
        ...
        for j in range(len(degree)):
            ...
            if save_step and os.path.isfile(str(example)+'/sol_krylov_equ_'+str(equ)+'_free_surf_'+str(free_surf)+'_ord_'+ord+'_Ndt_'+str(Ndt[i])+'_degree_'+str(degree[j])+'_dx_'+str(dx)+'_saved_t.npy'):
                ...
                var0=np.load(str(example)+'/sol_krylov_equ_'+str(equ)+'_free_surf_'+str(free_surf)+'_ord_'+ord+'_Ndt_'+str(Ndt[i])+'_degree_'+str(degree[j])+'_dx_'+str(dx)+'_saved_var0.npy')[:-(degree[j]+1)]
                sol_krylov_points=np.load(str(example)+'/sol_krylov_equ_'+str(equ)+'_free_surf_'+str(free_surf)+'_ord_'+ord+'_points_Ndt_'+str(Ndt[i])+'_degree_'+str(degree[j])+'_dx_'+str(dx)+"_saved.npy")
            else:
                NDt0=0
            ...
            for l in range(NDt0,NDt[i]):
                ...
                if l%1000==0 and save_step:
                    print('++++++++++++++++++++++++++++++++++++++++      SAVED KRY: degree - ',degree[j],', Ndt - ',Ndt[i],", l - ",l)
                    np.save(str(example)+'/sol_krylov_equ_'+str(equ)+'_free_surf_'+str(free_surf)+'_ord_'+ord+'_Ndt_'+str(Ndt[i])+'_degree_'+str(degree[j])+'_dx_'+str(dx)+'_saved_var0.npy',var)
                    np.save(str(example)+'/sol_krylov_equ_'+str(equ)+'_free_surf_'+str(free_surf)+'_ord_'+ord+'_Ndt_'+str(Ndt[i])+'_degree_'+str(degree[j])+'_dx_'+str(dx)+'_saved_t.npy',l)
                    np.save(str(example)+'/sol_krylov_equ_'+str(equ)+'_free_surf_'+str(free_surf)+'_ord_'+ord+'_points_Ndt_'+str(Ndt[i])+'_degree_'+str(degree[j])+'_dx_'+str(dx)+"_saved.npy",sol_krylov_points)

            np.save(str(example)+'/sol_krylov_equ_'+str(equ)+'_free_surf_'+str(free_surf)+'_ord_'+ord+'_points_Ndt_'+str(Ndt[i])+'_degree_'+str(degree[j])+'_dx_'+str(dx)+".npy",sol_krylov_points[::2,:])
            ...
            if os.path.isfile(str(example)+'/sol_krylov_equ_'+str(equ)+'_free_surf_'+str(free_surf)+'_ord_'+ord+'_Ndt_'+str(Ndt[i])+'_degree_'+str(degree[j])+'_dx_'+str(dx)+'_saved_t.npy'):
                ...
                os.remove(str(example)+'/sol_krylov_equ_'+str(equ)+'_free_surf_'+str(free_surf)+'_ord_'+ord+'_points_Ndt_'+str(Ndt[i])+'_degree_'+str(degree[j])+'_dx_'+str(dx)+"_saved.npy")
    return var[:-(degree[-1]+1)]
